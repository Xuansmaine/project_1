...
class GPSPage(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.mapview = MapView(zoom=13, lat=3.020786, lon=101.622825)
        # Add the MapView widget to the screen
        self.add_widget(self.mapview)
        # Create a popup for marker information
        self.popup = Popup(title="Infomation", content=Label(text=""), size_hint=(None, None), size=(600, 200))
...
class RUNPage(Screen):
    def __init__(self, **kwargs):
        ...
        self.button1 = Button(text= "Run AlderEyes",size_hint=(0.16,0.125),font_size=font_size,
        ...
        self.button2 = Button(text= "Sleep AlderEyes",size_hint=(0.16,0.125),font_size=font_size,
